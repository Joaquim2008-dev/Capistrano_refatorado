...
def criar_perfil_cliente(df_analise):
    """
    ...
    if len(idades_line) > 0:
        ...
        st.markdown("""
            ...
            .kpi-text-cliente { color: #ffffff; font-size: 10px; line-height:1.1; }
            .kpi-highlight { color: #d35400; font-weight:700; font-size: 10px; }
            </style>
    ...
    col_idade, col_sexo = st.tabs(['Por idade', 'Por sexo'])
    ...
    with col_idade:
        ...
        if 'idade_cliente_anos' in df_analise.columns:
            ...
            if len(idades_validas) > 0:
                ...
                opcao_sexo = st.radio(label='', options=["Masculino", "Feminino", "Ambos"],
                                          index=2, horizontal=True, key="radio_sexo_idades")
                ...
                if len(idades_filtradas) == 0:
                    ...
                    fig_idades.update_layout(
                        ...
                        xaxis_title="",
                        yaxis_title="",
                        height=190,                 # reduzir para diminuir espaço vertical
                        showlegend=False,
                        margin=dict(t=6, b=20, l=20, r=20),  # reduzir top margin
                        yaxis=dict(
                    ...
                    # exibir gráfico dentro do mesmo fluxo do container (já renderizado após o radio)
